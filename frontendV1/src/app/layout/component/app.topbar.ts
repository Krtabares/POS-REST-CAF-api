    ...
    template: ` <div class="layout-topbar">
        ...
        <div class="layout-topbar-actions">
            <div class="mr-3 hidden md:block">
                ...
                <select class="p-inputtext" [value]="branchService.selectedBranch()?._id || ''" (change)="onBranchIdChange($any($event.target).value)">
                    <option value="">Selecciona sucursal</option>
                    <option *ngFor="let b of branchService.branches()" [value]="b._id">{{ b.name }}</option>
                </select>
            </div>
...
export class AppTopbar implements OnInit {
    ...
    onBranchIdChange(id: string) {
        const branch = this.branchService.branches().find((b: Branch) => b._id === id) || null;
        this.branchService.selectBranch(branch);
    }
}
